...
module monitor_mm_interconnect_0 (
		...
		output wire        clock_s1_write,                                    //                                            .write
		input  wire [31:0] clock_s1_readdata,                                 //                                            .readdata
		output wire [31:0] clock_s1_writedata,                                //                                            .writedata
		output wire        clock_s1_chipselect,                               //                                            .chipselect
	...
	wire  [11:0] rsp_mux_src_channel;                                                                   // rsp_mux:src_channel -> nios2_processor_data_master_agent:rp_channel
	...
	wire  [11:0] rsp_mux_001_src_channel;                                                               // rsp_mux_001:src_channel -> nios2_processor_instruction_master_agent:rp_channel
	...
	wire  [11:0] cmd_mux_002_src_channel;                                                               // cmd_mux_002:src_channel -> nios2_processor_debug_mem_slave_agent:cp_channel
	...
	wire  [11:0] cmd_mux_004_src_channel;                                                               // cmd_mux_004:src_channel -> prg_MA_s1_agent:cp_channel
	...
	wire  [11:0] cmd_mux_005_src_channel;                                                               // cmd_mux_005:src_channel -> prg_WD_s1_agent:cp_channel
	...
	wire  [11:0] cmd_mux_006_src_channel;                                                               // cmd_mux_006:src_channel -> prg_RD_s1_agent:cp_channel
	...
	wire  [11:0] cmd_mux_007_src_channel;                                                               // cmd_mux_007:src_channel -> prg_clock_s1_agent:cp_channel
	...
	wire  [11:0] cmd_mux_008_src_channel;                                                               // cmd_mux_008:src_channel -> prg_we_s1_agent:cp_channel
	...
	wire  [15:0] reset_s1_agent_m0_address;                                                             // reset_s1_agent:m0_address -> reset_s1_translator:uav_address
	...
	wire  [94:0] reset_s1_agent_rf_source_data;                                                         // reset_s1_agent:rf_source_data -> reset_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] reset_s1_agent_rsp_fifo_out_data;                                                      // reset_s1_agent_rsp_fifo:out_data -> reset_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_009_src_data;                                                                  // cmd_mux_009:src_data -> reset_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                                 // reset_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [11:0] cmd_mux_009_src_channel;                                                               // cmd_mux_009:src_channel -> reset_s1_agent:cp_channel
	...
	wire  [15:0] clock_s1_agent_m0_address;                                                             // clock_s1_agent:m0_address -> clock_s1_translator:uav_address
	...
	wire  [94:0] clock_s1_agent_rf_source_data;                                                         // clock_s1_agent:rf_source_data -> clock_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] clock_s1_agent_rsp_fifo_out_data;                                                      // clock_s1_agent_rsp_fifo:out_data -> clock_s1_agent:rf_sink_data
	...
	wire         cmd_mux_011_src_valid;                                                                 // cmd_mux_011:src_valid -> clock_s1_agent:cp_valid
	wire  [93:0] cmd_mux_011_src_data;                                                                  // cmd_mux_011:src_data -> clock_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                                 // clock_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [11:0] cmd_mux_011_src_channel;                                                               // cmd_mux_011:src_channel -> clock_s1_agent:cp_channel
	wire         cmd_mux_011_src_startofpacket;                                                         // cmd_mux_011:src_startofpacket -> clock_s1_agent:cp_startofpacket
	wire         cmd_mux_011_src_endofpacket;                                                           // cmd_mux_011:src_endofpacket -> clock_s1_agent:cp_endofpacket
	...
	wire  [93:0] reset_s1_agent_rp_data;                                                                // reset_s1_agent:rp_data -> router_011:sink_data
	...
	wire         clock_s1_agent_rp_valid;                                                               // clock_s1_agent:rp_valid -> router_013:sink_valid
	wire  [93:0] clock_s1_agent_rp_data;                                                                // clock_s1_agent:rp_data -> router_013:sink_data
	wire         clock_s1_agent_rp_ready;                                                               // router_013:sink_ready -> clock_s1_agent:rp_ready
	wire         clock_s1_agent_rp_startofpacket;                                                       // clock_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire         clock_s1_agent_rp_endofpacket;                                                         // clock_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire  [11:0] cmd_demux_001_src4_channel;                                                            // cmd_demux_001:src4_channel -> cmd_mux_010:sink1_channel
	...
	wire  [11:0] rsp_demux_010_src1_channel;                                                            // rsp_demux_010:src1_channel -> rsp_mux_001:sink4_channel
	...
	wire         clock_s1_agent_rdata_fifo_src_valid;                                                   // clock_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire  [33:0] clock_s1_agent_rdata_fifo_src_data;                                                    // clock_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire         clock_s1_agent_rdata_fifo_src_ready;                                                   // avalon_st_adapter_011:in_0_ready -> clock_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_011_out_0_valid;                                                     // avalon_st_adapter_011:out_0_valid -> clock_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_011_out_0_data;                                                      // avalon_st_adapter_011:out_0_data -> clock_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_011_out_0_ready;                                                     // clock_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire   [0:0] avalon_st_adapter_011_out_0_error;                                                     // avalon_st_adapter_011:out_0_error -> clock_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.av_write               (clock_s1_write),                                    //                         .write
		.av_readdata            (clock_s1_readdata),                                 //                         .readdata
		.av_writedata           (clock_s1_writedata),                                //                         .writedata
		.av_chipselect          (clock_s1_chipselect),                               //                         .chipselect
		.av_read                (),                                                  //              (terminated)
		.av_begintransfer       (),                                                  //              (terminated)
		.av_beginbursttransfer  (),                                                  //              (terminated)
		.av_burstcount          (),                                                  //              (terminated)
	...
	monitor_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                     // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (clock_s1_agent_rdata_fifo_src_data),                //     in_0.data
		.in_0_valid     (clock_s1_agent_rdata_fifo_src_valid),               //         .valid
		.in_0_ready     (clock_s1_agent_rdata_fifo_src_ready),               //         .ready
